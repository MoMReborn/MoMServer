...
//Death Markers
datablock ItemData(GraveMarkerFoLData)
{
   shapeFile = "~/data/shapes/graves/folgrave01a_32.dts";
   mass = 1;
   friction = 1;
   elasticity = 0.3;
   sticky = true;
...
datablock ItemData(GraveMarkerMoDData)
{
   shapeFile = "~/data/shapes/graves/modgrave01_32.dts";
   mass = 1;
   sticky = true;
   friction = 1;
   elasticity = 0.3;
