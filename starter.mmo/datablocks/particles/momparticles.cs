...
datablock ParticleData(CastingParticle) {
   ...
   colors[1] = "1.000000 1.000000 1.000000 0.200000";
   colors[2] = "1.000000 1.000000 1.000000 0.500000";
   colors[3] = "1.000000 1.000000 1.000000 0.100000";
   sizes[0] = "0";
   sizes[1] = "0.05";
   sizes[2] = "0.1";
   sizes[3] = "0";
...
datablock ParticleEmitterData(CastingEmitter) {
   ejectionPeriodMS = "1";
   periodVarianceMS = "0";
   ejectionVelocity = "0.8";
   velocityVariance = "0.79";
   ejectionOffset = "0.6";
   thetaMin = "0";
   thetaMax = "180";
   phiReferenceVel = "0";
...
datablock ParticleData(SpellBeginParticle) {
   dragCoefficient = "0.33";
   windCoefficient = "0";
...
datablock ParticleEmitterData(SpellBeginEmitter) {
   ejectionPeriodMS = "1";
   periodVarianceMS = "0";
...
datablock ParticleData(CandleFire) {
   dragCoefficient = "0";
   windCoefficient = "1.12";
   gravityCoefficient = "-0.388278";
   inheritedVelFactor = "0";
   ...
   colors[0] = "0.779528 0.377953 0.000000 1.000000";
   colors[1] = "0.590551 0.181102 0.000000 1.000000";
   colors[2] = "0.181102 0.000000 0.000000 0.000000";
...
datablock ParticleData(DragonFireParticle) {
   dragCoefficient = "0.337243";
   windCoefficient = "0.36";
   gravityCoefficient = "-0.241758";
   inheritedVelFactor = "0.103718";
   constantAcceleration = "0.6";
   lifetimeMS = "1120";
   ...
   animateTexture = "0";
   framesPerSec = "0";
   textureName = "~/data/shapes/particles/fire2";
   animTexName[0] = "~/data/shapes/particles/fire2";
   colors[0] = "0.000000 0.000000 0.100000 0.598425";
   colors[1] = "0.700000 0.196850 0.000000 0.874016";
   colors[2] = "1.000000 0.700000 1.000000 1.000000";
...
datablock ParticleData(DragonSmokeParticle) {
   dragCoefficient = "0";
   windCoefficient = "1.08";
   gravityCoefficient = "-0.5";
   inheritedVelFactor = "1.05";
   ...
   animTexName[0] = "~/data/shapes/particles/smoke2";
   colors[0] = "1.000000 1.000000 1.000000 0.000000";
   colors[1] = "1.000000 1.000000 1.000000 0.181102";
   colors[2] = "1.000000 1.000000 1.000000 0.496063";
   colors[3] = "1.000000 1.000000 1.000000 0.078740";
   sizes[0] = "2.27";
   sizes[1] = "3.96";
   sizes[2] = "5.4";
   sizes[3] = "6.11";
...
datablock ParticleEmitterData(DragonSmokeEmitter) {
   className = "ParticleEmitterData";
   ejectionPeriodMS = "88";
   periodVarianceMS = "30";
   ejectionVelocity = "4";
...
datablock ParticleData(SmallBlackParticle)
{
   textureName          = "~/data/shapes/particles/smoke3";
   dragCoefficient      = 0.0;
...
datablock ParticleEmitterData(SmallBlackEmitter)
{
   ejectionPeriodMS = 20;
   periodVarianceMS = 5;
   ...
   particles = "SmallBlackParticle";
};

datablock ParticleEmitterNodeData(SmallBlackNode)
{
   timeMultiple = 1;
};
...
datablock ParticleData(GiganticBlackParticle)
{
   textureName          = "~/data/shapes/particles/smoke3";
   dragCoefficient      = 0.0;
   windCoefficient      = 1.0;
...
datablock ParticleEmitterData(GiganticBlackEmitter)
{
   ...
   particles = "GiganticBlackParticle";
};

datablock ParticleData(FloatingFortParticle)
{
   textureName          = "~/data/shapes/particles/orb";
   dragCoefficient      = 0.0;
   windCoefficient      = 0.0;
   ...
   colors[0]     = "1.000000 1.000000 1.000000 0.00";
   colors[1]     = "1.000000 1.000000 1.000000 0.05";
   colors[2]     = "1.000000 1.000000 1.000000 0.1";
   colors[3]     = "1.000000 1.000000 1.000000 0.00";
...
datablock ParticleEmitterData(FloatingFortEmitter)
{
   ejectionPeriodMS = 500;
   periodVarianceMS = 250;
   ...
   particles = "FloatingFortParticle";
};
...
datablock ParticleData(Fountain2Particle)
{
   textureName          = "~/data/shapes/particles/splash3";
   dragCoefficient      = 0.0;
   windCoefficient      = 0.0;
...
datablock ParticleEmitterData(Fountain2Emitter)
{
   ejectionPeriodMS = "38";
   periodVarianceMS = "25";
   ...
   orientParticles = "0";
   orientOnVelocity = "1";
   particles = "Fountain2Particle";
   lifetimeMS = "0";
   lifetimeVarianceMS = "0";
   useEmitterSizes = "0";
   useEmitterColors = "0";};

datablock ParticleEmitterNodeData(Fountain2Node)
{
   timeMultiple = 1;
};
// Water Fountain (sparkles)
// ----------------------------------------

datablock ParticleData(Fountain3Particle)
{
   textureName          = "~/data/shapes/particles/fleck";
   dragCoefficient      = 0.0;
   windCoefficient      = 0.0;
...
datablock ParticleEmitterData(Fountain3Emitter)
{
   ejectionPeriodMS = "2";
   periodVarianceMS = "0";
   ejectionVelocity = "3.8";
   velocityVariance = "0";
   ejectionOffset = "0";
   thetaMin = "1";
   thetaMax = "35";
...
datablock ParticleEmitterNodeData(Fountain3Node)
{
   timeMultiple = 1;
};
