...
for cl in RPG_REALM_LIGHT_CLASSES:
    StartingGear(realm=RPG_REALM_LIGHT,classname=cl,items="Bottomless Pit,Key Ring,Drinking Water,Tasty Meal,Green Key,Red Key,Plain Gloves,Plain Helm,Plain Boots,Plain Shirt,Plain Arms,Plain Pants,Longsword,Magic Shield,Longsword,Broadsword")

for cl in RPG_REALM_DARKNESS_CLASSES:
    StartingGear(realm=RPG_REALM_DARKNESS,classname=cl,items="Bottomless Pit,Key Ring,Drinking Water,Tasty Meal,Green Key,Red Key,Plain Gloves,Plain Boots,Plain Helm,Plain Shirt,Plain Arms,Plain Pants,Longsword,Magic Shield,Longsword,Broadsword")
